...
FastAPI segmentation service with a polished Streamlit dashboard. The API predicts customer segments from transaction features, and the dashboard can call the API or run locally against the bundled artifacts.
...
Deploy the API and the dashboard as separate Web Services if you want the interactive UI.
